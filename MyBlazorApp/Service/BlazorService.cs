...
public class BlazorService : IBlazorService
{
    ...
    public async Task<List<ProductVM>> GetAll()
    {
        ...
        var fetchedProducts = await _httpClient.GetFromJsonAsync<List<ProductVM>>("https://localhost:44384/api/products/GetProducts");
    ...
    public async Task Delete(int productId)
    {
        try
        {
            var response = await _httpClient.DeleteAsync($"https://localhost:44384/api/products/DeleteProduct/{productId}");
            response.EnsureSuccessStatusCode();
    ...
    {
        var product = await _httpClient.GetFromJsonAsync<ProductVM>($"https://localhost:44384/api/products/GetProduct/{productId}");
        return product;
    }
    public async Task Update(ProductVM updatedProduct)
    {
        try
        {
            ...
            var response = await _httpClient.PutAsJsonAsync($"https://localhost:44384/api/products/EditProduct/{productId}", updatedProduct);
            response.EnsureSuccessStatusCode();
